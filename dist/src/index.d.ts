...
declare class Libp2p extends Libp2p_base {
     ...
     * @returns {Promise<Connection|*>}
     */
    dialProtocol(peer: import("peer-id") | Multiaddr | string, protocols: undefined | string[] | string, options?: {
        signal?: AbortSignal | undefined;
...
declare namespace Libp2p {
    export { create, Multiaddr, Connection, MuxedStream, Pubsub, PeerStoreOptions, PeerDiscoveryOptions, RelayOptions, Libp2pConfig, Libp2pOptions, CreateOptions };
}
...
type Libp2pOptions = {
    ...
    dialer?: import('./dialer').DialerOptions;
