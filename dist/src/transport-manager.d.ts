...
declare class TransportManager {
    ...
    _transports: Map<string, import("libp2p-interfaces/src/transport/types").Transport<any>>;
     ...
     * @returns {void}
     */
    add(key: string, Transport: import("libp2p-interfaces/src/transport/types").TransportFactory<any>, transportOptions?: any): void;
    /**
     * Stops all listeners
     *
     * @async
     ...
     */
    getTransports(): IterableIterator<import("libp2p-interfaces/src/transport/types").Transport<any>>;
    /**
     ...
     */
    transportForMultiaddr(ma: Multiaddr): import("libp2p-interfaces/src/transport/types").Transport<any> | null;
    /**
...
type TransportFactory = import("libp2p-interfaces/src/transport/types").TransportFactory<any>;
type Transport = import("libp2p-interfaces/src/transport/types").Transport<any>;
/**
